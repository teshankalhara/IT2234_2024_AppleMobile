      ...
      <div className="mx-auto container p-4">
        <div className="bg-white p-5 w-full max-w-sm mx-auto roun">
          ...
          <form className="pt-6 flex flex-col gap-2" onSubmit={handleSubmit}>
            ...
            <button className="bg-red-600 text-white font-bold text-xl px-6 py-2 w-full max-w-[150px] rounded-full hover:scale-110 transition-all mx-auto block mt-6 hover:bg-red-800">
              Sign up
            </button>
          </form>
